...
Resumable via a sidecar checkpoint; OOM-resilient retry. Run after the backfill finishes.
    ...
    RERUN_LIMIT=1 uv run python -m state_access.v2.rerun_gap_anchors 30   # smoke
    uv run python -m state_access.v2.rerun_gap_anchors                    # all gap cells
"""
...
from state_access.v2.repatch_account_sweep import (
    MAX_ATTEMPTS,
    RETRY_BASE_DELAY,
    account_columns,
    parquet_for,
