...
Resumable via a sidecar checkpoint, OOM-resilient retry, atomic parquet writes.
    ...
    uv run python -m state_access.v2.repatch_account_sweep            # all affected cells
    REPATCH_LIMIT=1 uv run python -m state_access.v2.repatch_account_sweep 30  # smoke
"""
