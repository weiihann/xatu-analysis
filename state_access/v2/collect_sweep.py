...
skip anchors already present.
    ...
    uv run python -m state_access.v2.collect_sweep [T ...]   # default: 30 90 180 365
    SWEEP_LIMIT=2 uv run python -m state_access.v2.collect_sweep 30   # smoke run
"""
...
from state_access.v2.config import DATA_DIR_V2, SWEEP_STEP, SWEEP_WINDOWS, anchors_v2
