...
re-runs skip anchors already present.
    ...
    LIMIT=1 uv run python -m state_access.collect_v2_creation_reads 30 90 180 365  # gate: anchor only
    uv run python -m state_access.collect_v2_creation_reads                        # full sweep
"""
...
from state_access.config_v2 import DATA_DIR_V2, SWEEP_WINDOWS, anchors_v2
