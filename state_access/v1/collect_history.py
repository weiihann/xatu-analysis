...
Reuses the verified query builders in state_access.v1.queries, one anchor at a time,
...
Run with:  uv run python -m state_access.v1.collect_history [W ...]
e.g.        uv run python -m state_access.v1.collect_history 90 180 365
