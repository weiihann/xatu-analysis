...
![Hot share vs window](../data/v1/hot_share_vs_window.png)
...
![Tiering tradeoff](../data/v1/tradeoff_cold_vs_writes.png)
...
![Gas concentration](../data/v1/gas_concentration.png)
...
![Concentration over time, W=30](../data/v1/history_w30_gas_concentration.png)
![Concentration over time, W=90](../data/v1/history_w90_gas_concentration.png)
![Concentration over time, W=180](../data/v1/history_w180_gas_concentration.png)
![Concentration over time, W=365](../data/v1/history_w365_gas_concentration.png)

**Cold-state share** — flat within each window; the level steps down as `W` widens (more state is
touched over a longer lookback):

![Cold state over time, W=30](../data/v1/history_w30_state_cold.png)
![Cold state over time, W=90](../data/v1/history_w90_state_cold.png)
![Cold state over time, W=180](../data/v1/history_w180_state_cold.png)
![Cold state over time, W=365](../data/v1/history_w365_state_cold.png)
...
![Cold share across windows over time](../data/v1/history_windows_cold.png)
...
![Writes to cold over time, W=30](../data/v1/history_w30_writes_cold.png)
![Writes to cold over time, W=90](../data/v1/history_w90_writes_cold.png)
![Writes to cold over time, W=180](../data/v1/history_w180_writes_cold.png)
![Writes to cold over time, W=365](../data/v1/history_w365_writes_cold.png)
...
![Warm state vs gas/block](../data/v1/gas_warm_set_perblock.png)
...
![Warm-state share vs gas/block](../data/v1/gas_warm_set_perblock_pct.png)
...
![State-access intensity per gas](../data/v1/gas_intensity.png)
