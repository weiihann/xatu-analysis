...
persisted after every chunk; re-runs skip `(kind, bn_lo)` pairs already present.
    ...
    uv run python -m state_access.collect_v2_history
"""
...
from state_access.config_v2 import ANCHOR_BLOCK_V2, DATA_DIR_V2, MERGE_BLOCK
...
KINDS: dict[str, tuple[Callable[[int, int], str], bool]] = {
    "slot_write": (queries_v2.slot_write_event_totals, False),
    "account_balance_write": (queries_v2.account_balance_write_totals, False),
    "account_nonce_write": (queries_v2.account_nonce_write_totals, False),
    "account_contract_create": (queries_v2.account_contract_create_totals, False),
    "slot_read": (queries_v2.slot_read_event_totals, True),
    "account_balance_read": (queries_v2.account_balance_read_totals, True),
    "account_nonce_read": (queries_v2.account_nonce_read_totals, True),
    "account_appearance_read": (queries_v2.account_appearance_read_totals, True),
}
